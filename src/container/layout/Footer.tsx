    ...
    return (
        <FooterContainer>
            ...
            <div className="footer-content__div">
                <div>
                    <img
                        src="https://reactportfolioteam.github.io/shoppingMall-react-project/images/icon/vane.svg"
                        width="24px"
                        height="18px;"
                        alt="vane"
                    />
                ...
                <div>
                    <div>
                        <img
                            src="https://reactportfolioteam.github.io/shoppingMall-react-project/images/icon/instagram.svg"
                            className="make-button"
                            alt="instagram"
                        />
                        <img
                            src="https://reactportfolioteam.github.io/shoppingMall-react-project/images/icon/twitter.svg"
                            className="make-button"
                            alt="twitter"
                        />
                    </div>
